...
def test_user2(client):
    user_data = {"email": "user123@gmail.com", "password": "pass1234"}
...
def test_user(client):
    user_data = {"email": "user@gmail.com", "password": "pass1234"}
    res = client.post("/users/", json=user_data)
    assert res.status_code == 201
    # print(res.json())
    new_user = res.json()
...
def test_posts(test_user, session, test_user2):
    ...
    #session.add_all([models.Post(title="firste title", content="firste content", owner_id= test_user['id']),
